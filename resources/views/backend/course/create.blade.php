        ...
        <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="color[]" required class="form-control my-colorpicker1">
                  </div>
                </div>
                <div class="col-sm-4">
                 <div class="form-group">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" name="courseImage" onchange="readURL(this,0)"
                  id="exampleInputFile">
            ...
            <div class="text-center">
              <img src="/defaults/defaultImage.png" id="showImage" alt="Girl in a jacket" width="auto" height="200">
            </div>
            <div class="form-group">
              <label for="logo">Course Logo</label>
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" name="logo" onchange="readURL(this,1)"
                  id="logo">
            ...
            <div class="text-center">
              <img src="/defaults/defaultImage.png" id="showLogo" alt="Girl in a jacket" width="auto" height="200">
            </div>
          </div>
        </div>
      </div>
