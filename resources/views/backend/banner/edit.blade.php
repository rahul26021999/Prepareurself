...
<script>
  ...
  if($("#screen").val()=='feedback' || $("#screen").val()=='allCourse' || $("#screen").val()=='prefrence'){
    $('#screen_id').hide();
  }
              ...
              <div class="col-sm-9">
                <div class="form-group">
                    ...
                    <select name="screen" id="screen" class="form-control">
                      ...
                      <option value="project" <?php  if($banner['screen']=='project') echo 'selected'; ?> >Open project Screen</option>
                    </select>
                </div>
              </div>
             
              <div class="col-sm-3" id="screen_id" hide >
                <div class="form-group">
