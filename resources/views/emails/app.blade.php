...
"><img src="{{url('/defaults/social/instagram_color.png')}}"  style="vertical-align: middle;" alt="instagram" width="44" height="47" /></a> 
                            <a href="https://www.facebook.com/prepareurself.in
"><img src="{{url('/defaults/social/facebook_color.png')}}" alt="facebook" width="38" style="vertical-align: middle;" height="47" /></a>
                             <a href="https://www.linkedin.com/company/42810956/"><img src="{{url('/defaults/social/linkedin_color.png')}}"  style="vertical-align: middle;" alt="linkedin" width="40" height="47" /></a>
                           </td>
                        </tr>
                      </tbody>
                    </table>
